        ...
        for key, individual in population.items():
            ...
            for box_number, r in zip(individual['order'], individual['rotate']):
                ...
                for pos in dblf:
                    ...
                    # if last_box_value is not None and abs(box_value - last_box_value) > tolerance:
                    #     continue  # Eğer fark toleranstan büyükse bu pozisyonda yerleştirme yapılmaz    
                    ...
                    if space_vol >= box_vol and pos[3] >= l and pos[4] >= w and pos[5] >= h:
                        ...
                        top_space = [pos[0], pos[1], pos[2] + h, l, w, pos[5] - h] #yukseklik
                        beside_space = [pos[0], pos[1] + w, pos[2], l, pos[4] - w, pos[5]] #genislik
                        front_space = [pos[0] + l, pos[1], pos[2], pos[3] - l, pos[4], pos[5]] # uzunluk
                        dblf.remove(current)
