...
class PopulationService:
    ...
    def generate_pop(box_params, count, rotation=5):
        ...
        """
        18- 26 satir arasi ilk once gelen kutularin 'l' parametresine gore kucukten buyuge siralayip
        sonrasinda her sorted. keyslere gore girilen rotatiton ile random atama yapiliyor. bunu her bir population icin ve 
        her bir box_parametresi icin tekrar ediyor.
        """
        population = {}
        if count > 5:
            x = 5
            ...
            x = count
        sorted_box = dict(sorted(box_params.items(), key=lambda x: x[1][4]))
