...
class Dimension(models.Model):
    ...
    volume = models.DecimalField(max_digits=10, decimal_places=2, editable=False)  # Auto-calculated
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    is_deleted = models.BooleanField(default=False)
    deleted_time = models.DateTimeField(null=True, blank=True)
...
class WeightType(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    std = models.DecimalField(max_digits=10, decimal_places=2)
    eco = models.DecimalField(max_digits=10, decimal_places=2)
